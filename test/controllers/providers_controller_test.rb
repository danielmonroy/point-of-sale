...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference("Provider.count") do
      post providers_url, params: { provider: { comments: @provider.comments, name: @provider.name, store_id: @provider.store_id } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { comments: @provider.comments, name: @provider.name, store_id: @provider.store_id } }
